        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                @if ($errors->any())
                    ...
                    <div class="border border-t-0 bg-red-400 rounded-b bg-red-100 px-3 py-4 text-red-700">
                        <p>
                            <ul>
            ...
            <form class="w-full" action="{{ route('food.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-600 text-xs italic">Example: Garlic, Potato, Tomato</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-600 text-xs italic">Example: recomended, popular, new..food</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
